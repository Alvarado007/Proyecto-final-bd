...
public class VentanaAgregarPedido extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        Nombre_ventana = new Labeltransparente("Pedidos");
        Label_cambio1 = new Labeltransparente("Num Pedido");
        Label_cambio2 = new Labeltransparente("Fecha Encargo");
        Label_cambio3 = new Labeltransparente("Fecha Entrega");
        Label_cambio4 = new Labeltransparente("Abono");
        Label_cambio5 = new Labeltransparente("Anotacion");
        Label_cambio6 = new Labeltransparente("Dni Cliente");
    ...
    //         public void run() {
    //             new VentanaAgregarPedido().setVisible(true);
    //         }
    //     });
    // }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Boton_guardar) {
            if (Modo == "Editar"){
                int num_pedido = Integer.parseInt(Cambio1.getText());
                String fecha_encargo = Cambio2.getText();
                String fecha_entrega = Cambio3.getText();
                int abono = Integer.parseInt(Cambio4.getText());
